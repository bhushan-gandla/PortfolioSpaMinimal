export const portfolioItems: any[] = [
    ...
    },
    {
      ...
      value: 2,
      content: '<p class="t-18">EXOS Underwriter is a complete end-to-end appraisal review solution, enhancing appraisal risk management through dynamic QC rule management and industry-leading data. </p><p class="t-18">I designed and developed dashboards for this app. The app was completely responsive and the dashboards included charts and data points that enabled users to make key decisions. </p>',
      client: "ServiceLink",
      clicked: false,
      toolsUsed: [
        {
